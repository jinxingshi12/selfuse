//+------------------------------------------------------------------+
//|                                          Javier Gold Scalper.mq4 |
//|                        Copyright 2022, MetaQuotes Software Corp. |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
#property copyright "Javier Trading Scalper Gold";
//roperty copyright "Copyright 2022, MetaQuotes Software Corp."
...
input double PercentageRisk = 0.1;
input int PercentageRiskBasedOnPointsMovement = 100;
input string BalanceRatioSettings = "***************************";
input double ForEvery = 1000;
input double UseLotsForEveryBalance = 0.01;
input string LotsSelection = "***************************";
input LotAss LotAssignment = Fixed;
input int TakeProfit = 30;
input double Tral = 20;
input double TralStart = 5;
input double TimeStart = 2;
input double TimeEnd = 23;
input double MaxSpread = 40;
input double PipsStep = 35;
input int OpenTime = 1;
input int Magic = 2021;
input bool Info = true;
input color TextColor = White;
input color InfoDataColor = DodgerBlue;
input color FonColor = 0;
...
int OnInit()
{
   ...
   Ib_00024 = false;
   Il_00028 = 0;
   Is_00030 = "JAVIER TRADING SCALPER";
   Ii_0003C = 0;
   Ii_00040 = 0;
   Id_00048 = 0;
   Il_00050 = 0;
...
void OnTick()
{
   ...
   if (!Ib_00024)
   {
      ...
      if (Gi_00006 >= 0)
      {
         do
         {
            if (OrderSelect(Gi_00007, SELECT_BY_POS, MODE_TRADES) && _Symbol == OrderSymbol() && OrderMagicNumber() == Magic)
            {
      ...
      if (Gi_00009 >= 0)
      {
         do
         {
            if (OrderSelect(Gi_0000A, SELECT_BY_POS, MODE_TRADES) && _Symbol == OrderSymbol() && Magic == OrderMagicNumber())
            {
      ...
      if (Gi_00011 >= 0)
      {
         do
         {
            if (OrderSelect(Gi_00012, SELECT_BY_POS, MODE_TRADES) && _Symbol == OrderSymbol() && Magic == OrderMagicNumber())
            {
      ...
      if (Gi_00019 >= 0)
      {
         do
         {
            if (OrderSelect(Gi_0001A, SELECT_BY_POS, MODE_TRADES) && OrderMagicNumber() == Magic)
            {
      ...
      if (Gl_0001B < Gl_00019 || AccountInfoInteger(ACCOUNT_LIMIT_ORDERS) == 0)
      {
         ...
         if (Gi_0001D >= 0)
         {
            do
            {
               if (OrderSelect(Gi_0001E, SELECT_BY_POS, MODE_TRADES) && _Symbol == OrderSymbol() && OrderMagicNumber() == Magic)
               {
         ...
         if (Gi_0001C == 0)
         {
            ...
            if (Gi_00020 >= 0)
            {
               do
               {
                  if (OrderSelect(Gi_00021, SELECT_BY_POS, MODE_TRADES) && _Symbol == OrderSymbol() && Magic == OrderMagicNumber())
                  {
            ...
            if (Gi_00028 >= 0)
            {
               do
               {
                  if (OrderSelect(Gi_00029, SELECT_BY_POS, MODE_TRADES) && _Symbol == OrderSymbol() && Magic == OrderMagicNumber())
                  {
      ...
      if (Gi_00030 >= 0)
      {
         do
         {
            if (OrderSelect(Gi_00031, SELECT_BY_POS, MODE_TRADES) && OrderMagicNumber() == Magic)
            {
      ...
      if (Gi_00033 >= 0)
      {
         do
         {
            if (OrderSelect(Gi_00034, SELECT_BY_POS, MODE_TRADES) && OrderMagicNumber() == Magic)
            {
      ...
      if ((Gd_00032 >= Ld_FFFF0) && (Ld_FFFF0 != 0))
      {
         ...
         if (Gi_00036 >= 0)
         {
            do
            {
               if (OrderSelect(Gi_00037, SELECT_BY_POS, MODE_TRADES) && _Symbol == OrderSymbol() && Magic == OrderMagicNumber())
               {
         ...
         if (Gi_00035 > 1)
         {
            ...
            if (Gi_00036 >= 0)
            {
               do
               {
                  if (OrderSelect(Gi_00038, SELECT_BY_POS, MODE_TRADES) && OrderMagicNumber() == Magic)
                  {
                     if (OrderType() == OP_BUY)
                     {
                        RefreshRates();
      ...
      if (Gi_0003E >= 0)
      {
         do
         {
            if (OrderSelect(Gi_0003F, SELECT_BY_POS, MODE_TRADES) && _Symbol == OrderSymbol() && Magic == OrderMagicNumber())
            {
      ...
      if (Gi_00041 >= 0)
      {
         do
         {
            if (OrderSelect(Gi_00042, SELECT_BY_POS, MODE_TRADES) && _Symbol == OrderSymbol() && OrderMagicNumber() == Magic)
            {
      ...
      if (Gi_00044 >= 0)
      {
         do
         {
            if (OrderSelect(Gi_00045, SELECT_BY_POS, MODE_TRADES) && OrderMagicNumber() == Magic)
            {
   ...
   if (iTime(NULL, 1440, 0) <= Il_00028)
      return;

   if (!ResumeTradingAtNextDayAfterDrawdown)
      return;
...
void func_1018()
{
   ...
   do
   {
      if (OrderSelect(Li_FFFE0, SELECT_BY_POS, MODE_TRADES) && OrderSymbol() == _Symbol && OrderMagicNumber() == Magic)
      {
         ...
         else if (OrderType() == OP_SELL && (Tral != 0))
         {
            if (Ld_FFFE8 > Ld_FFFF0 || (Ld_FFFE8 == 0))
            {
...
void func_1037(string Fa_s_00)
{
   ...
   if (Li_FFFF8 >= 0)
   {
      do
      {
         if (OrderSelect(Li_FFFF8, SELECT_BY_POS, MODE_TRADES) && OrderMagicNumber() == Magic && OrderSymbol() == _Symbol && OrderComment() == Is_00030)
         {
            if (OrderType() == OP_BUY)
            {
